    ...
    public class ProductoService : IProductoService
    {
        ...
        public async Task<ProductoDTO> Crear(ProductoDTO modelo)
        {
            try
            {
                ...
                if (productoCreado.IdProducto == 0) throw new TaskCanceledException("No se puede crear");
        ...
        public async Task<bool> Editar(ProductoDTO modelo)
        {
            try
            {
                ...
                if (productoEncontrado == null) throw new TaskCanceledException("Producto no existe");
        ...
        public async Task<bool> Eliminar(int id)
        {
            try
            {
                ...
                if (productoEncontrado == null) throw new TaskCanceledException("El producto no exixte");
